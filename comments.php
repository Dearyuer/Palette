...
<div id="comments" class="comments-area">
	...
	<!-- <nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'palette' ); ?></h1>
		<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'palette' )  ); ?></div>
	...
	<p class="no-comments"><?php _e( 'Comments are closed.', 'palette' ); ?></p>
	<?php endif; ?>
