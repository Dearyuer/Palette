...
<div class="container clearfix">
	...
	<div class="main-area">
		<!-- scrape -->
		<div class="contri">
			<div class="contri-title"><a href="#"><span><i class="fa fa-sticky-note posts-title-icon" aria-hidden="true"></i></span> 动态</a><a href="#"><span><i class="fa fa-bars right" aria-hidden="true"></i></span></a></div>
			<?php 
