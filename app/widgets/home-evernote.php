...
class Palette_Home_Evernote_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$evernoteSvg = '<svg width="19px" height="19px" viewBox="63 -31 34 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        echo '<div class="component-identifier"><span class="home-evernote-icon">'.$evernoteSvg.'</span></div>';
		$output = '';
